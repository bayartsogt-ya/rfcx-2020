...
class STFT(DFTBase):
    def __init__(self, n_fft=2048, hop_length=None, win_length=None,
        ...
        """
        Implementation of STFT with Conv1d. The function has the
        same output of librosa.core.stft
        """
...
class LogmelFilterBank(nn.Module):
    def __init__(self, sr=32000, n_fft=2048, n_mels=64,
                 fmin=50, fmax=14000, is_log=True, ref=1.0,
